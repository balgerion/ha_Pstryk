...
class PstrykPriceSensor(CoordinatorEntity, SensorEntity):
    ...
    def extra_state_attributes(self) -> dict:
        ...
        return {
            ...
            all_prices_key: [{"start": p["start"], "price": p["price"]} for p in today],
            best_prices_key: [{"start": p["start"], "price": p["price"]} for p in sorted_prices["best"]],
            worst_prices_key: [{"start": p["start"], "price": p["price"]} for p in sorted_prices["worst"]],
            best_count_key: self.top_count,
            worst_count_key: self.worst_count,
