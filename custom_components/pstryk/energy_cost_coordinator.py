...
class PstrykCostDataUpdateCoordinator(DataUpdateCoordinator):
    ...
    async def _async_update_data(self, fetch_all: bool = True):
        ...
        try:
            ...
            if fetch_all:
                ...
                try:
                    monthly_data = await self.api_client.fetch(monthly_url)
                ...
                try:
                    yearly_data = await self.api_client.fetch(yearly_url)
    ...
    def _normalize_frame(self, frame):
        ...
        return {
            ...
            "fae_cost": frame.get(
                "fae_cost",
                cost.get("energy_active_import_register_cost", cost.get("total_cost", 0) or 0),
            ),
            ...
            "energy_cost_net": frame.get(
                "energy_cost_net",
                cost.get("energy_active_import_register_cost", 0) or 0,
            ),
            ...
            "energy_sold_value": frame.get(
                "energy_sold_value",
                cost.get("energy_active_export_register_value", 0) or 0,
            ),
